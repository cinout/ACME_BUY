...
export const styleFormTypeArea =
  "rounded-md outline-none bg-sky-50 text-sky-900 px-4 placeholder:text-sky-600 placeholder:italic placeholder:text-sm";
export const styleFormLabel = "font-bold block mb-0.5";
/**
 * Form - Image
 */
...
export const styleSubmitButton =
  "text-white px-3 py-1 w-fit rounded-full border-2 border-sky-100 bg-aqua-forest-600 not-disabled:hover:bg-aqua-forest-500 not-disabled:hover:scale-105 transition shadow-2xl disabled:cursor-not-allowed disabled:bg-slate-300  h-9";
