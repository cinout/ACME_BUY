      ...
      <div className="h-10 grid grid-cols-2 gap-x-3 px-4">
        ...
        >
          <input
            ...
            type="text"
            className={
              "z-40 h-8 bg-sky-100 border-sky-800 border-2 box-content rounded-md px-4 text-sky-950 outline-none"
            }
          />

          <button
            className="z-40 text-[2.3rem] text-aqua-forest-400 hover:text-aqua-forest-500 transition "
